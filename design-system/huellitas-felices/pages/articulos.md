...
- **Badge de estado**: usa la paleta de estado del sistema (`StatusBadge`, ver MASTER.md "Status Colors") — `Activo` = variante `success` (verde vibrante), `Inactivo` = variante `neutral` (gris crema). Punto + texto, nunca color solo.
